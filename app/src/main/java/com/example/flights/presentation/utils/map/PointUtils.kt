...
fun pointInQuadCurve(point1: Point, point2: Point, point3: Point, fraction: Double): Point {
...
fun pointInCubicCurve(point1: Point, point2: Point, point3: Point, point4: Point, fraction: Double): Point {
